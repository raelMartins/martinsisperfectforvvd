  ...
  return (
    <div className="group relative shrink-0">
      <button
        ...
        className="theme-fade flex h-10 w-10 items-center justify-center rounded-full transition-opacity hover:opacity-80 sm:h-11 sm:w-11 md:h-12 md:w-12 lg:h-[60px] lg:w-[60px]"
